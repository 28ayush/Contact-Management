...
function Layout() {
  ...
  return (
    <div className="">
      <aside
        id="default-sidebar"
        className={`fixed top-0 left-0 z-50 w-64 h-screen transition-transform -translate-x-full ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"
          } sm:translate-x-0`}
      >
          ...
          <ul className="space-y-8 font-medium">
            ...
            <li>
              ...
              >
                <Link to="/map">
                  <span className="text-xl text-white">
                    <FontAwesomeIcon icon={faChartLine} /> Chart and Map
                  </span>
                </Link>
              </span>
            </li>
